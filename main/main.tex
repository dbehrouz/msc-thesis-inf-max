...
\subsubsection{Simple Implementation Token Based}
A variation of simple implementation method, where the simulation aspect of the \textbf{Independent Cascade} is implemented. In this algorithm, each vertex, instead of trying to activate its neighbors only once, it will try many times. T
