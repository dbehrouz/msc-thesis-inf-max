...
hadoop jar target/giraph-hadoop-1.0-SNAPSHOT.jar com.bd.mapreduce.TopN /ic/output/hep /ic/output/final 100

hadoop jar target/giraph-hadoop-1.0-SNAPSHOT.jar com.bd.mapreduce.TopN /ic/output/hep-multi /ic/output/final-multi 100
