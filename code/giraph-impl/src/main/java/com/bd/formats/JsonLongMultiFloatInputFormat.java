 ...
 */
public class JsonLongMultiFloatInputFormat extends
        TextVertexInputFormat<LongWritable, MultiAttemptVertexValue, FloatWritable> {
    @Override
    ...
    private class JsonLongLongFloatLongVertexReader extends TextVertexReaderFromEachLineProcessedHandlingExceptions<JSONArray,
        ...
        @Override
        protected MultiAttemptVertexValue getValue(JSONArray jsonVertex) throws
                JSONException, IOException {
            return new MultiAttemptVertexValue(MultiAttemptSingleCycle.ATTEMPTS);
        }
        ...
        @Override
        protected Vertex<LongWritable, MultiAttemptVertexValue, FloatWritable>
